 ...
 * 
 * <p>Minau is a test runner that discovers and executes tests implementing the 
 * {@code work.archaic.service.test.v01.TestSuite} interface. It provides parallel test execution
 * using Java virtual threads, making it efficient for running large test suites.
 * 
 * <h2>Key Features</h2>
 * <ul>
 *   <li>Automatic test discovery through module scanning</li>
 *   <li>Parallel test execution using virtual threads within test classes</li>
 *   <li>Thread-safe result collection and reporting</li>
 *   <li>Structured test output with timing statistics</li>
 *   <li>TestSuite lifecycle management (setup/teardown)</li>
 *   <li>Exit code based on test results (0 for success, 1 for failures)</li>
 * </ul>
 * 
 * <h2>Usage</h2>
 ...
 * <p><b>Options:</b>
 * <ul>
 *   <li>{@code --output-dir <dir>} - Directory for output files (default: "out")</li>
 * </ul>
 * 
 * <p><b>Examples:</b>
 * <pre>{@code
 ...
 * 
 * <h2>Writing Tests</h2>
 * <p>Tests must implement the {@code TestSuite} interface from {@code work.archaic.service.catalog}:
 * <pre>{@code
 ...
 * <ol>
 *   <li>Test discovery via module scanning</li>
 *   <li>For each test class:
 *     <ol type="a">
 *       <li>Create instance and call {@code setup()}</li>
 *       <li>Execute all {@code @Test} methods in parallel using virtual threads</li>
 *       <li>Collect results from all test threads</li>
 *       <li>Call {@code teardown()}</li>
 *     </ol>
 *   </li>
 *   <li>Generate summary report with statistics</li>
 * </ol>
 * 
 * <h2>Output Format</h2>
 ...
 * <h2>Requirements</h2>
 * <ul>
 *   <li>Java 21 or later (uses virtual threads)</li>
 *   <li>Assertions must be enabled ({@code -ea} flag)</li>
 *   <li>Test modules must export packages containing test classes</li>
 * </ul>
 * 
